...
<div class="top">
	...
	<div class="menu">
		<c:if test="${empty user}">
			...
			<a class="menu-link" href="#">选修课程管理</a>|
			<a class="menu-link" href="#">选修课程表</a>|
		...
		<c:if test="${not empty user}">
			...
			<c:if test="${not empty isAdmin && isAdmin}">
				...
				<a class="menu-link" href="addElective.do">新建选修课程</a>|
			...
			<c:if test="${not empty isAdmin && isAdmin}">
				<a class="menu-link" href="electiveAdmin.do">选修课程管理</a>|
			</c:if>
			<a class="menu-link" href="electiveList.do">选修课程表</a>|
